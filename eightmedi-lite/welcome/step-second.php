	...
	<div class="feature-section recommended-plugins">
		...
		<div class="col plugin_box">
			<?php if ( $prop['recommended'] ): ?>
				<span class="recommended"><?php esc_html_e( 'Recommended', 'eightmedi-lite' ); ?></span>
			<?php endif; ?>
			...
			<div class="b-wrap">
			<span class="version"><?php esc_html_e( 'Version:', 'eightmedi-lite' ); ?><?php echo esc_html( $info->version ) ?></span>
